...
pluralCaseList.push( {plural: "recommendationAndBookings/travels", pascal: "RecommendationAndBookingTravel"} )

pluralCaseList.push( {plural: "customerSupports/supports", pascal: "CustomerSupportSupport"} )

pluralCaseList.push( {plural: "partnershipManagements/partnerships", pascal: "PartnershipManagementPartnership"} )

pluralCaseList.push( {plural: "collaborationManagements/collaborations", pascal: "CollaborationManagementCollaboration"} )
